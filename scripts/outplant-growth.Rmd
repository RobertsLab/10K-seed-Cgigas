...
```{r}
data%>%
  dplyr::select(date, purple.tag, tag.20250820, oyster, treatment, Predicted_Volume_Poly)%>%
  ...
  write_csv("output/baywater_growth.csv")
```