...
plot1<-final%>%
  ...
  geom_smooth(method="lm", colour="black", fill="darkgray")+
  geom_text(aes(x=7e+04, y=3.8), label="p<0.001")+
  ylab(expression(paste(Delta, "Fluorescence")))+
  xlab(expression(paste("Volume (mm" ^-3, ")")))+
  theme_classic();plot1

ggsave(plot1, filename="figures/resazurin/size_10k_oysters.png", width=8, height=6)
```
